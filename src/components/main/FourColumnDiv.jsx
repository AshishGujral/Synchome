  ...
  return (
    <div className="group-42">
      <div className="container" style={getContainerStyles(waterPump)}>
        ...
        <div className="Switch"><Switch checked={waterPump} onChange={() => setWaterPump(!waterPump)}  /></div>
      ...
      <div className="container" style={getContainerStyles(temperature)}>
        ...
        <div className="Switch"> <Switch checked={temperature} onChange={() => setTemperature(!temperature)} /></div>
      ...
      <div className="container" style={getContainerStyles(motionSensor)}>
        ...
        <div className="Switch"><Switch checked={motionSensor} onChange={() => setMotionSensor(!motionSensor)} /></div>
      ...
      <div className="container" style={getContainerStyles(lights)}>
        ...
        <div className="Switch"> <Switch checked={lights} onChange={() => setLights(!lights)} /></div>

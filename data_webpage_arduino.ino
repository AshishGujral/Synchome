...
String str1 = "<p>I am SyncHome</p>"; //String to display on webpage
...
void wifi_init() //send AT commands to module
{
  ...
  if (!No_IP)
  {
    ...
    establishConnection("AT+CWJAP=\"Pixel_7601\",\"6046144043\"", 7000); //provide your WiFi username and password here
  }
  else
  {
  }
